...
<title><h1>IAM- Web Application by Arvind PREMANANDHAM</h1></title>
</head>
...
%>
<h1>IAM- Web Application by Arvind PREMANANDHAM</h1>
<div class="container">
    <div class="jumbotron">
...
<div class="container">
     <form class="form-horizontal" action="Update" method="post" role="form">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input class="form-control" name="username" value="<%=identity.getUsername() %>" id="uid" placeholder="login" />
            </div>
        </div>
        <div class="form-group">
